import { Game, GameObject, Painter, Camera3D, Screen, WebGLAttractorPipeline, AccordionGroup, Dropdown, Slider, Button, VerticalLayout, Text, UI_THEME, THEMES } from "/gcanvas.es.min.js";
...
export class NavierStokesDemo extends Game {
  constructor(canvas) {
    ...
    this.zoom = CONFIG.ui.defaultZoom;
