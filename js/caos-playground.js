...
const ATTRACTOR_PRESETS = {
  lorenz: {
    ...
    energyFlow: { intensity: 0.45, speed: 1.3 },
    blink: {
      chance: 0.33,
      intensityBoost: 1.5,
  ...
  dadras: {
    ...
    energyFlow: { intensity: 0.4, speed: 1.4 },
    blink: {
      chance: 0.14,
      intensityBoost: 1.4,
      saturationBoost: 1.15,
  ...
  thomas: {
    ...
    energyFlow: { intensity: 0.35, speed: 1.0 },
    blink: {
      chance: 0.15,
      intensityBoost: 1.4,
      saturationBoost: 1.15,
  ...
  halvorsen: {
    ...
    energyFlow: { intensity: 0.45, speed: 1.6 },
    blink: {
      chance: 0.05,
      intensityBoost: 0.5,
  ...
  aizawa: {
    ...
    energyFlow: { intensity: 0.35, speed: 1.2 },
    blink: {
      chance: 0.01,
      intensityBoost: 0.1,
      saturationBoost: 0.1,
  ...
  chen: {
    ...
    energyFlow: { intensity: 0.5, speed: 1.6 },
    blink: {
      chance: 0.1,
      intensityBoost: 2.5,
      saturationBoost: 1.15,
  ...
  chua: {
    ...
    glow: { enabled: true, radius: 150, intensity: 1.75 },
    energyFlow: { intensity: 0.35, speed: 1.1 },
    blink: {
      chance: 0.33,
      intensityBoost: 0.4,
      saturationBoost: 0.5,
  ...
  threeScroll: {
    ...
    energyFlow: { intensity: 0.4, speed: 1.5 },
    blink: {
      chance: 0.09,
      intensityBoost: 1.6,
      saturationBoost: 1.3,
  ...
  rabinovichFabrikant: {
    ...
    energyFlow: { intensity: 0.4, speed: 1.3 },
    blink: {
      chance: 0.35,
      intensityBoost: 1.7,
      saturationBoost: 1.15,
