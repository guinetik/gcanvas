...
const ATTRACTOR_PRESETS = {
  lorenz: {
    label: "Lorenz",
    attractor: { dt: 0.009, scale: 10 },
    particles: { count: 300, trailLength: Math.PI * 100, spawnRange: Math.PI/2 },
    center: { x: 0, y: 0, z: 27 },
    camera: { perspective: 800, rotationX: 4.5, rotationY: 3.2 },
    visual: { minHue: 15, maxHue: 100, maxSpeed: 100, saturation: 70, lightness: 30, maxAlpha: 0.1, hueShiftSpeed: 12 },
    glow: { enabled: true, radius: 50, intensity: 2 },
    blink: { chance: 0.033, intensityBoost: 2.5 },
    mouseControl: { horizontalAxis: "rotationZ" },
    zoom: { min: 0.3, max: 2.5 },
    restart: { delay: 1 },
    spawnOffset: { z: 27 },
    normalizeRotation: true,
    respawnChance: 0.00798,
    autoRotation: { enabled: false, speed: 0.15, axis: "z" },
  },
  dadras: {
    label: "Dadras",
    attractor: { dt: 0.01, scale: 70 },
    particles: { count: 300, trailLength: 175, spawnRange: 5 },
    center: { x: 0, y: 0, z: 0 },
    camera: { perspective: 800, rotationX: -0.895, rotationY: 0.000, rotationZ: -0.595 },
    visual: { minHue: 25, maxHue: 75, maxSpeed: 70, saturation: 70, lightness: 50, maxAlpha: 0.15, hueShiftSpeed: 20 },
    glow: { enabled: true, radius: 100, intensity: 2.9 },
    blink: { chance: 0.015, intensityBoost: 1.1, alphaBoost: 1.1 },
  ...
  thomas: {
    label: "Thomas",
    attractor: { dt: 0.09, scale: 75 },
    particles: { count: 400, trailLength: 150, spawnRange: 3 },
    ...
    blink: { chance: 0.001, alphaBoost: 0.1 },
  ...
  rossler: {
    ...
    particles: { count: 300, trailLength: 150, spawnRange: 3 },
    center: { x: 0, y: 0, z: 0 },
    camera: { perspective: 500, rotationX: 0.5, rotationY: 0 },
    visual: { minHue: 150, maxHue: 85, maxSpeed: 70, saturation: 70, lightness: 25, maxAlpha: 0.1, hueShiftSpeed: 10 },
    glow: { enabled: true, radius: 100, intensity: 0.75 },
    blink: { chance: 0.05, intensityBoost: 0.1, saturationBoost: 0.1, alphaBoost: 0.1 },
  ...
  chen: {
    label: "Chen",
    attractor: { dt: 0.008, scale: 25 },
    particles: { count: 350, trailLength: 300, spawnRange: 10 },
    center: { x: 0, y: 0, z: 12 },
    ...
    glow: { enabled: true, radius: 80, intensity: 1.75 },
    blink: { chance: 0.8, intensityBoost: 2.5 },
    warmupSteps: 1,
    zoom: { min: 0.2, max: 2.5 },
    mouseControl: { horizontalAxis: "rotationZ" },
    normalizeRotation: true,
  ...
  aizawa: {
    label: "Aizawa",
    attractor: { dt: 0.025, scale: 150 },
    particles: { count: 350, trailLength: 100, spawnRange: 0.1 },
    center: { x: 0, y: 0, z: 0.65 },
    camera: { perspective: 800, rotationX: 0.4, rotationY: 0 },
    visual: { minHue: 290, maxHue: 340, maxSpeed: 70, saturation: 70, lightness: 40, maxAlpha: 0.2, hueShiftSpeed: 4 },
    glow: { enabled: true, radius: 85, intensity: 3.75 },
    blink: { chance: 0.02, intensityBoost: 1.2 },
    zoom: { min: 0.3, max: 2.5 },
    axisMapping: "yz-swap",
  ...
  chua: {
    ...
    visual: { minHue: 120, maxHue: 170, maxSpeed: 70, saturation: 70, lightness: 35, maxAlpha: 0.15, hueShiftSpeed: 25 },
    glow: { enabled: true, radius: 150, intensity: 0.75 },
    blink: { chance: 0.3, intensityBoost: 1.4 },
  ...
  threeScroll: {
    ...
    camera: { perspective: 800, rotationX: -3.163, rotationY: 0.000, rotationZ: 2.135, screenRotation: 0.000 },
    visual: { minHue: 380, maxHue: 300, maxSpeed: 70, saturation: 70, lightness: 35, maxAlpha: 0.15, hueShiftSpeed: 30 },
    glow: { enabled: true, radius: 150, intensity: 0.75 },
    blink: { chance: 0.25, intensityBoost: 1.6, saturationBoost: 1.3, alphaBoost: 1.4 },
