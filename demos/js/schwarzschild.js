...
import { Game, Painter, Camera3D, Screen, Gesture, FPSCounter } from "../../src/index.js";
...
import { Text, Scene, applyAnchor } from "../../src/index.js";
...
class SchwarzschildDemo extends Game {
  ...
  _buildInfoHeader() {
    ...
    this._hudItems = [this._titleText, this._equationText, this._massText, this._rsText, this._orbitText];
